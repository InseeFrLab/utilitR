...
::: {.callout-tip .bigger320}
## `utilitR` ne couvre pas tous les besoin, loin s'en faut!
...
Si c'est le cas, `utilitR` n'est peut-être pas le meilleur point d'entrée, et nous vous conseillons de regarder en bas de cette page, où vous attendent des liens vers des ressources qui répondront probablement mieux à votre besoin.
