...
Néanmoins, nous ne prétendons pas à l'exhaustivité ; de ce point de vue, les utilisateurs qui ne trouveraient pas de réponse à leurs questions sont invités à alimenter le projet. C'est le propre d'un projet collaboratif, ouvert à tous, dans lequel chacun est invité à apporter sa pierre à l'édifice, dans la mesure bien évidemment de ses connaissances. Il doit donc se voir comme une mise en commun des connaissances que chacun détient individuellement à divers problèmes se posant dans le travail quotidien relatif à `R`.
