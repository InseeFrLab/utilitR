...
Tout agent intéressé à contribuer au projet `UtilitR` est cordialement invité à consulter le [guide des contributeurs](CONTRIBUTING.md). Toutes les contributions sont les bienvenues: compléments, corrections d'erreur, améliorations, questions...
