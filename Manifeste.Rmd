...
**Nous nous sommes donc fixés pour objectif de rassembler tous les éléments utiles pour l'usage de `R` à l'Insee dans un seul document, en cherchant à aborder le plus grand nombre possible de cas d'usage.** Néanmoins, nous ne prétendons pas à l'exhaustivité ; de ce point de vue, les utilisateurs qui ne trouveraient pas de réponse à leurs questions sont invités à alimenter le projet. C'est le propre d'un projet collaboratif, ouvert à tous, dans lequel il invite chacun à apporter sa pierre à l'édifice, dans la mesure bien évidemment de ses connaissances. Il doit donc se voir comme une mise en commun des connaissances que chacun détient individuellement à divers problèmes se posant dans le travail quotidien relatif à `R`.
