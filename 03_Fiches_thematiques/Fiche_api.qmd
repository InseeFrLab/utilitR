...
La fonction [req_retry de `httr2`](https://httr2.r-lib.org/reference/req_retry.html), utilisée dans les exemples précédents, permet 
de gérer automatiquement et intelligemment la relance des requêtes en cas de quota de requête atteint.
