...
![Comment `R Markdown` produit-il un document?](./pics/rmarkdown/schema_rmd.png)
...
![](./pics/rmarkdown/perso_options.png)
...
`r if(knitr::is_html_output()){"![](resources/rmarkdown/chunk07.html){width=100%}"}`
`r if(knitr::is_latex_output()){"\\includepdf[clip=0mm 0mm 0mm 0mm, trim=20mm 40mm 20mm 15mm,pages=-,frame,scale=.65,pagecommand={}]{resources/rmarkdown/chunk07.pdf}"}`
...
![](./pics/rmarkdown/googlescholar.png)
