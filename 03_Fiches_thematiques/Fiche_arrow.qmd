...
options(arrow.use_threads = TRUE) # <1>
arrow::set_cpu_count(parallel::detectCores() %/% 2)
```
1. Autoriser `arrow` à utiliser plusieurs processeurs en parallèle
2. Définir le nombre de processeurs qu'arrow peut utiliser
