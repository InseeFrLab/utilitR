...
- Les instructions figurant entre ces deux étapes (le `group_by()` puis le `summarise()`) sont exécutées par le moteur d'exécution de `duckdb`, de façon complètement transparente pour l'utilisateur.
