...
Il est également souhaitable de lire préalable la fiche XXXX et de vérifier que les éléments de configuration de `Git` présentés dans cette fiche sont fonctionnels.
...
* Utiliser les interfaces `Github` ou `Gitlab` pour fusionner deux branches. Sur ce point, vous pouvez consulter la formation [Travail collaboratif avec R](https://linogaliana.gitlab.io/collaboratif/git.html).
