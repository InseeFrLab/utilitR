...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/create_project_0b.png")
```

Sur `Github`, il s'agit du bouton `Code` :

```{r, echo = FALSE}
utilitr::include_image("./pics/git/create_project_0.png")
```
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/create_project_1.png")
```
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/create_project_2.png")
```
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/create_project_3.png")
```
...
utilitr::include_image("./pics/git/onglet_git1.png", ratio_compression = 1)
```
...
```{r, echo = FALSE, out.width= '60%'}
utilitr::include_image("./pics/git/onglet_git3.png", ratio_compression = 1)
```
...
utilitr::include_image("./pics/git/onglet_git4.png", ratio_compression = 1)
```
...
utilitr::include_image("./pics/git/onglet_git5.png", ratio_compression = 1)
```
...
```{r, echo = FALSE, out.width= '50%'}
utilitr::include_image("./pics/git/onglet_git6.png", ratio_compression = 1)
```
...
```{r, echo = FALSE, out.width= "75%"}
utilitr::include_image("./pics/git/onglet_git7.png", ratio_compression = 1)
```
:::
...
C’est une des fonctionnalités les plus pratiques de la gestion de version. La création de **branches** dans un projet permet de développer des codes sans modifier la version de référence des codes. Cela signifie que `Git` permet de faire cohabiter plusieurs versions des mêmes codes sans risque de confusion, et de fusionner facilement des versions différentes.

Dans un projet collaboratif, une branche appelée le plus souvent `main` ou `master` joue le rôle de version de référence. C’est autour d’elle que vont pousser ou se greffer les branches comme le montre l’exemple ci-dessous:
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/onglet_git8.png")
```
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/onglet_git9.png")
```
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/git-bash.png")
```
