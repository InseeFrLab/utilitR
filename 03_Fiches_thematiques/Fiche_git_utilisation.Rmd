...
Après avoir choisi un nom pour le projet, il est possible, à ce moment-là,
de choisir la visibilité du dépôt (privé ou public). Plus de détails sont
disponibles dans la
[documentation officielle de Github](https://docs.github.com/en/github/getting-started-with-github/create-a-repo)
