...
```{r}
include_image("https://linogaliana.gitlab.io/collaboratif/pics/03_git/branches_tree.png")
```
...
::: {.recommandation}
L'usage de la ligne de commande `Git` est à utiliser avec tact et mesure :
