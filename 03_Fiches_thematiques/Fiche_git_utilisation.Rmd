...
Une présentation d'une utilisation `Git` pour débutants:

```{r, echo = FALSE}
knitr::include_url("https://www.youtube.com/watch?v=zNzZ1PfUDNk](https://www.youtube.com/watch?v=lyzWU43DJ9I")
