...
**Cette étape ne doit être réalisée qu'une seule fois par projet.**
Il se peut que le dépôt distant existe déjà, par exemple si vous rejoignez
un projet déjà lancé, ou si un de vos collègues a déjà créé le dépôt. Dans ce
cas, vous pouvez passer directement à l'[étape 2](#recuperer-url).
