...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/onglet_git1.png")
```
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/onglet_git3.png")
```
...
```{r, echo = FALSE}
utilitr::include_image("./pics/git/onglet_git6.png")
```
