...
* `pull` ![](./pics/git/pull.png){width = "40"}: récupérer les modifications présentes sur le dépôt distant ;
* `push` ![](./pics/git/push.png){width = "40"}: envoyer les modifications faites en local sur le dépôt distant.
