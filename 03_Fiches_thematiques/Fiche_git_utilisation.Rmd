...
C'est grâce à cet onglet que vous pourrez effectuer la plupart des opérations `Git` courantes, qui sont présentées à partir de la section [Premiers pas en local](#git-local).
