...
avec vos collègues ou stocker vos codes personnels. La marche à suivre est
...
, les fonctionnalités pour créer un
nouveau dépôt sont . Dans les deux cas, après avoir choisi
le nom du dépôt, il est possible de choisir la visibilité de celui-ci (privé ou public), le créer vide ou avec un fichier README minimal ou suivre un
...
que pour des projets statistiques). 
