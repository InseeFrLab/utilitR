...
Ce fichier est modifiable et il est souvent nécessaire de lui ajouter quelques lignes pour exclure un certain nombre de fichiers. Par exemple, vous pouvez ajouter les lignes suivantes pour exclure
tous les fichiers csv, SAS et Excel du suivi des modifications :
