...
## Packaged permettant une utilisation simple des API
...
postes nomades équipés qui accèdent à internet par ce biais.
...
**TO BE COMPLETED: là il faudrait un exemple de requête sur une API simple**
