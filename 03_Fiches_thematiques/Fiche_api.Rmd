...
Pour accéder à des données via une API, il est recommandé de vérifier, en premier
...
le _package_ `httr` pour transmettre la requête à l'API et le _package_ `jsonlite` pour la
retravailler afin d'obtenir un dataframe plus classique.
...
`jsonlite`, facilitent l'extraction de champs d'une sortie d'API. 
