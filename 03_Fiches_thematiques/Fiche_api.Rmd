...
Si l'accès à internet se fait par l'intermédiaire d'un proxy, il est recommandé
...
des programmes plus reproductibles. 
...
Les API présentent également l'avantage pour l'utilisateur de données de pouvoir extraire facilement une petite partie d'une base de données plus conséquente.
