...
La grammaire `tidyverse` s'inspire du SQL pour fournir des commandes dont l'enchaînement est intelligible même sans faire tourner le code. Par exemple, la ligne `matable %>% select(mavarible) %>% summarise()` est facilement compréhensible. 
