...
Jusqu'à présent, mous avons manipulé un `data.table` existant, mais nous ne lui avons pas ajouté de nouvelles colonnes. Pour ce faire, nous allons utiliser l'opérateur `:=`. Voici comment on crée une nouvelle colonne dans `iris_dt`:
