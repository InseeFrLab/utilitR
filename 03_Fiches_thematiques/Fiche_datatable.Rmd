...
Les autres options sont visibles avec `?data.table::merge`. Il existe d'autres manières de faire des jointures, plus poussées, présentées dans la [vignette sur le sujet](https://rstudio-pubs-static.s3.amazonaws.com/52230_5ae0d25125b544caab32f75f0360e775.html).
...
| **`dcast()`**                                    | **`melt()`**                                         |
| :----------------------------------------------: | :--------------------------------------------------: |
| Réorganise les donnée dans un format large       | Réorganiser les donnée dans un format long           |
|![](./pics/datatable/longtowide.png){width=62%}  |![](./pics/datatable/widetolong.png){width=55%}      |
