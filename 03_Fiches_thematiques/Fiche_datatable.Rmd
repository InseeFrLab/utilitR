...
resultat <- 
  iris_dt[ ,
           Total.Length := Sepal.Length + Petal.Length
              ...
              .(moyenne = mean(Total.Length, na.rm = TRUE)), 
              by = Species
              ][
                order(moyenne)
                ]
...
L'nchaînement des opérations en `data.table` est puissant, mais peut aboutir à des résultats non désirés si on ne fait pas attention. Voici deux exemples proches qui aboutissent à des résultats très différents:
