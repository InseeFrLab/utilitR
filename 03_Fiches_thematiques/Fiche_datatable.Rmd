...
Vous pouvez utiliser toutes les fonctions statistiques de `R` avec `data.table`. Le *package* `data.table` propose par ailleurs quelqdesues fonctions optimisées qui peuvent vous être utiles. En voici quelques-unes:
