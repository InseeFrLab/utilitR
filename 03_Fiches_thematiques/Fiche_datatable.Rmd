...
::: {.remarque}
La fonction `.N` permet de créer facilement des compteurs avec la syntaxe `1:.N`. Par exemple `dt[ , compteur := 1:.N, by = 'group_var']` permet de créer une variable `compteur` qui vaut de 1 à N pour chaque groupe d'observations défini par `group_var`.
:::
