...
On peut considérer l'opérateur `:=` comme la traduction de la fonction `dplyr::mutate()` dans la grammaire `data.table`. Mais il faut garder en tête que son fonctionnement est complètement différent (et beaucoup plus rapide), car  Par exemple, pour créer une nouvelle colonne, on adopte la syntaxe suivante:
