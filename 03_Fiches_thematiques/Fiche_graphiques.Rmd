...
- en modifiant les options une à une (titres du graphique et des axes, graduation des axes...);
...
Chaque nouvel élément graphique est à rajouter sous forme d'une couche ou _layer_ supplémentaire. Ici, nous utilisons la fonction **labs** qui permet de définir les titres de tous les éléments possibles de l'aesthétic, ainsi que le titre général du graphique (*title*), le sous-titre (*subtitle*) et le bas de page (*caption*). À noter qu'il existe plusieurs autres façons de spécifier ces élèments par des couches spécifiques: `ggtitle`, `xlab`, `ylab`,...
