...
Les différentes couches graphiques se superposent et s'enchaînent grâce à l'opérateur `+`, comme un pipe. Il est possible d'aller à la ligne dans une instruction `ggplot()`, il suffit que l'opérateur `+` figure à la fin de la ligne.
