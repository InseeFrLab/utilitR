...
3. l'*add-in* [`esquisse`](https://cran.r-project.org/web/packages/esquisse/readme/README.html), qui permet de réaliser des graphiques par une interface graphique.
