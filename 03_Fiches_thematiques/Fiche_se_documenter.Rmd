...
* au niveau francophone, la communauté est très présente sur le [slack](https://fr.wikipedia.org/wiki/Slack_(plateforme)) [r-grrr](r-grrr.slack.com) (inscription nécessaire mais libre). On peut également poser des questions sur le [forum francophone](http://forums.cirad.fr/logiciel-R/index.php) ;
