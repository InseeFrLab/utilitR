...
- **Il est recommandé d'utiliser la fonction `read_xlsx()` du package `openxlsx` pour importer des *fichiers xlsx*. **
- **Il est recommandé d'utiliser la fonction `read_excel()` du package `readxl` pour importer des *fichiers xls*.**
- **Il est recommandé d'utiliser la fonction `read_ods` du package `readODS` importer des *fichiers odt*. **
...
## Import d'un fichier tabulé avec le package `readODS`
...
| `range`             |  NULL                 | sélection d'un rectangle à l'aide d'une plage de cellules de type Excel, comme `range = "D12:F15"`. Le traitement de la plage de cellules est géré par le package `cellranger`.                                                                |
