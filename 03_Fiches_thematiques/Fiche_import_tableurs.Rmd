...
## **1. Import d'un fichier `xlsx` ou `xls`**
...
**Les paramètres**  
La fonction `read_excel()` du package `readxl`, qui fait partie du `tidyverse`, permet d’importer des données directement depuis un fichier au format `xls` ou `xlsx`. Cette fonctions à les paramètres suivants 

* `path` : *- pas de valeur par défaut -* Chemin d'accès au fichier xls / xlsx;
