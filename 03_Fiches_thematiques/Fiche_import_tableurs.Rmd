...
![Interface d'importation de Rstudio: Exemple 1](./import_donnees_tabulees_tests/img/1_import_IHM.png)
...
![Interface d'importation de Rstudio: Exemple 2](./import_donnees_tabulees_tests/img/2_import_IHM avec_param_sheet_range_NA.png)
