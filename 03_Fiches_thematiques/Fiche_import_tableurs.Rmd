...
- Adapter en conséquence le chemin ci-dessous en remplaçant `../import_donnees_tabulees_tests` par votre chemin menant au fichier `/mes_donnees.xls`. **Exemple :** `D:/T19QHL/Mes Documents/R_workSpace/documentationR`.
