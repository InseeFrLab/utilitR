...
- télécharger [le jeu de données ici](https://gitlab.com/linogaliana/documentationR/-/tree/master/import_donnees_tabulees_tests) puis le sauvegarder sur votre poste;
...
- télécharger [les jeux de données ici](https://gitlab.com/linogaliana/documentationR/-/tree/master/import_donnees_tabulees_tests) puis le sauvegarder sur votre poste;
