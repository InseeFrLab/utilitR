...
Le _package_ `survey` présente l'avantage de fournir un cadre général pour l'estimation sur données d'enquête, mais il occulte des aspects pratiques communs à bon nombre d'enquêtes, ce qui rend souvent les cakculs de variance inadaptés à la réalité des enquêtes. En particulier, les estimations de variance prennent difficilement voire pas du tout en compte l'effet de la non-réponse totale et du calage sur marges sur la précision. 
