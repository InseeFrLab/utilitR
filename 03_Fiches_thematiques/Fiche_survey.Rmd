...
L'utilisateur souhaite exploiter des données d'enquête pour calculer des indicateurs. En particulier, l'enjeu est d'utiliser correctement les pondérations des données d'enquête dans le calcul des indicateurs.
