...
Ce qui distingue ici la cible `resultat`  de ce qui a été vu précédement, c'est l'utilisation de l'argument `pattern`, qui a vocation à itérer sur les vecteurs cibles x et y grâce à `map`.
