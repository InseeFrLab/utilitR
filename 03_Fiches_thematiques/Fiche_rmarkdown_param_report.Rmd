...
- un rapport automatisé, reproductible et facile à actualiser en cas de modification des données ;
- produire de nombreux rapports sur un même modèle en modifiant en faisant varier certains paramètres.
