...
La compilation de ce fichier, au travers de la commande `rmarkdown::render(input = rapportParametre.Rmd.Rmd)` génèrera le document suivant :
...
monRapport <- function(codeDpt) {
	rmarkdown::render(input = "rapportParametre.Rmd",
