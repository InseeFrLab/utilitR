...
La dernière étape de l'utilisation des rapports paramétrés consiste à en automatiser la production avec une fonction. Voici comment définir une fonction qui génère automatiquement un rapport 
...
```{r automatisation, include = FALSE}
GenererRapportDep <- function(codeDpt) {
