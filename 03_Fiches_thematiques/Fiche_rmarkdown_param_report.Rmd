...
Si vous ne connaissez pas `R Markdown`, il est indispensable de lire au préalable la [fiche `R Markdown`](#rmarkdown).
:::
...
Un rapport automatisé réalisé avec `R Markdown` est un fichier texte portant l'extension `.Rmd` permettant de composer aisément un document. Ce document "de sortie" (ou *output*) est produit après une étape de compilation, en cliquant sur le bouton `knit` de `RStudio` ®. Le document produit peut prendre plusieurs formes : 
