...
La méthode la plus simple pour configurer `knitr` consiste à inclure un *chunk* de configuration au début du fichier `R Markdown` (juste après l'en-tête). Le *chunk* de configuration définit les options par défaut, applicables à tous les _chunks_ du code source. Voici un exemple.
