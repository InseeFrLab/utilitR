...
Le *package* `sf` est une boîte à outils conçue pour faciliter la manipulation de données spatiales. 


Il s'agit d'une extension de `dplyr` pour les objets géographiques. On peut donc utiliser le *pipe* (`%>%`) pour chaîner des opérations. A COMPLETER AVEC UNE REFERENCE AU GUIDE DE BONNES PRATIQUES, PARTIE PIPE
