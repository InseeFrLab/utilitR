...
1. des **données géographiques** (ou géométries) : objets géométriques tels que des points, des lignes, des polygones, ou des maillages (*raster*). Exemple : la forme de chaque chaque commune, les coordonnées d'un bâtiment ;
