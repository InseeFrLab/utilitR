...
::: {.conseil data-latex=""}
**Conseils**
Les jointures spatiales peuvent être très gourmandes en ressources (car il peut être nécessaire de croiser toutes les géométries de `x` avec toutes les géométries de `y`), ce qui peut saturer l'ordinateur sur lequel vous travaillez. Voici deux conseils qui peuvent vous aider:
...
## Où trouver des données géographiques/*shapefiles* ?
