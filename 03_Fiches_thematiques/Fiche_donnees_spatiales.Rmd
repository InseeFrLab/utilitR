...
::: specificite
Ce package n'étant pas disponible sur le CRAN, sous AUS, il convient de l'installer directement depuis un fichier présent dans le répertoire , avec la commande `install.packages(CHEMIN_VERS_LE_FICHIER_ZIP, repos = NULL)`. 
:::
