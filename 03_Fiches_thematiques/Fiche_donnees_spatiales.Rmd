...
Il peut arrive que les données géographiques ne soient pas stockées dans un format adapté. Par exemple, vous pouvez disposer d'un fichier `.csv` qui contient une table géolocalisées de logements avec leur caractéristiques. En ce cas, vous pouvez créer une table de donnée géographiques en deux temps:
