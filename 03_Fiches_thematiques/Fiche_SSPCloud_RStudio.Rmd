...
## 4. Exporter son projet `formationShiny`
<br>

Il n'est pas nécessaire de conserver son service `RStudio` en permanence "en cours" sur `SSp Cloud`. Il faudra donc, une fois la formation terminée, le syupprimer. Avant cela, vous voudrez probablement conserver votre travail.  

- Sélectionner ce qui doit être exporté :  

  - le dossier `formationShiny`,
  - le `~.RProj`
