...
![Options générales](./pics/rprojects/05_options.png){width=60%}
...
![Exemple d'options pour les packages](./pics/rprojects/05_options_build.png){width=60%}
...
![Exemple d'options git](./pics/rprojects/05_options_git.png){width=60%}
