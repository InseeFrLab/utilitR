...
partie de ce document. Vous souhaitez donc déterminer si un _package_ déjà existant
...
Si vous souhaitez utiliser un package pour une application en production à l'Insee, vous pouvez aussi vérifier s'il a été validé par le [Comité de Certification des _packages_ `R`](https://www.agora.insee.fr/cms/sites/sgi/home/libre-service-statistique/les-comites-1/cops-1.html) (CoPs).
 
Vous pouvez également demander au _CoPs_ de procédér à une analyse approfondie d'un _package_ que vous envisagez d'utiliser.
