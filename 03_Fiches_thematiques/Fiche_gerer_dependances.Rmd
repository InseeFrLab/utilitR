...
- lorsqu'un package est déclaré dans le champ `Imports` ainsi que dans le champ
  ...
  disponible sur le CRAN mais "ailleurs".
...
sécurité, le package `{usethis}` propose des fonctions permettant de réaliser
...
modifier en respectant ses règles de fonctionnement.
