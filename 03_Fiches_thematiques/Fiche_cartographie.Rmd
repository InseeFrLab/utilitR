...
plot(st_geometry(europe), graticule=T, axes=T)
```

### Transformations / projections

Pour connaitre le CRS d'un objet spatial, il faut utiliser la fonction `st_crs`. Il est possible de modifier la projection d'une carte grâce à la fonction `sf::st_transform`. Cette fonction attend 2 paramètres :
...
lon <- sf::st_coordinates(st_centroid(st_geometry(europe_centree)))[, 1]
lat <- sf::st_coordinates(st_centroid(st_geometry(europe_centree)))[, 2]
