# Comment renforcer la réplicabilité d'un programme `R`?
...
fonctionnera bien. Dans les deux cas, le code est le même à l'exception des *packages* qui sont chargés dans un ordre différent. Pour éviter cela, la syntaxe avec `::` est préférable:
<div class="fold o">
```{r eval = T}
