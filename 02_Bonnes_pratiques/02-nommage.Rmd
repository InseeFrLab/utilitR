# Comment nommer les objets dans `R`? {.nommage}
...
## Choix des noms des fichiers (scripts et données)
...
* **Ne pas utiliser `T` ou `F` pour nommer des variables** (car ce sont les abréviations des booléens TRUE et FALSE);
