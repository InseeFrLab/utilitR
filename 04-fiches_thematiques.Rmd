...
Ainsi, pour importer le fichier des communes du COG en imposant que le code commune soit lu comme une chaîne de caractères et le numéro de région comme un nombre entier, on écrit le code suivant: 
