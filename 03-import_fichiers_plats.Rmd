...
* Elle permet de sélectionner les colonnes qu'on veut importer;
...
* l'option `colClasses` doit prendre la forme suivante: `colClasses = c(var1 = "character", var2 = "logical", var4 = "double")`;
