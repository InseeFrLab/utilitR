...
```{r "entree_fiche_AUSv3", out.extra = 'style="display: inline-block; padding : 0; width: 40px;"', echo = FALSE}
...
```{r "desktop_AUS", echo = FALSE, out.width= "75%", fig.cap= "Ecran d'accueil de la collection RPython d'AUSv3"}
