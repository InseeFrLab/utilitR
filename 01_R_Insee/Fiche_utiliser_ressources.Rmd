...
```{r, echo = FALSE, fig.cap= "Le gestionnaire des tâches Windows"}
include_image("./pics/utiliser_ressources/TskMngr1small.png", ratio_compression = 1)
```
...
include_image("./pics/utiliser_ressources/TskMngr2bis.png", ratio_compression = 1)
```
