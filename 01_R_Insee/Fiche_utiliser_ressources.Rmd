...
Les paragraphes suivant donnent quelques conseils pour limiter votre consommation de mémoire vive.

### Importer uniquement les données nécessaires

La saturation de la mémoire vive est souvent provoquée par un utilisateur qui essaie d'importer des données très volumineuses. **Voici deux bonnes pratiques à adopter, en particulier lorsque la taille de l'ensemble des données que vous souhaitez importer avec `R` est supérieure à 5 Go:**
