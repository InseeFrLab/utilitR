...
Il est possible de prévenir la plupart des difficultés en adoptant trois bonnes pratiques:
...
## Comment superviser sa session `R`?

Vous pouvez facilement superviser sa session `R` avec le gestionnaire des tâches. Pour ouvrir le gestionnaire des tâches, il suffit d'utiliser le raccourci présent sur le bureau de votre session AUS, ou d'utiliser le raccourci clavier suivant: <kbd>Ctrl</kbd> + <kbd>⇧ Shift</kbd> + <kbd>Echap</kbd>.
