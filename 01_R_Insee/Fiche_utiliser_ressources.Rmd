...
<kbd>Ctrl</kbd> + <kbd>⇧ Shift</kbd> + <kbd>Suppr</kbd>.

::: specificite

Pour ouvrir le gestionnaire des tâches, il suffit d'utiliser le raccourci
présent sur le bureau de votre session AUS, ou d'utiliser le raccourci
