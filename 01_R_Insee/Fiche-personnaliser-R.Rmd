...
La personnalisation de `R`, ou de `RStudio` doit être réalisée avec précaution, car personnaliser son environnement de travail, c'est prendre le risque de rendre moins reproductible ses travaux.
