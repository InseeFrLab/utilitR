...
L'agent souhaite personnaliser sa configuration de `R` ou de `RStudio`. Cette personnalisation consiste à définir certaines actions ou valeurs qui seront effectuées automatiquement à l'ouverture d'une session `R`.
...
```{r warning=TRUE}
vecteurbooleen <- c(TRUE, FALSE)
if (vecteurbooleen) {
  message("Je suis vrai !")
} else {
  message("Je suis faux !")
}
```
