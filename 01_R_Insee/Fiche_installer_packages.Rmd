...
**Il est indispensable d'inclure les instructions de chargement de _package_ au début d'un programme `R`.**


::: {.conseil data-latex=""}
Il est conseillé de regrouper les instructions de chargement de _packages_ dans les premières lignes des programmes `R`, car cela permet à un utilisateur qui ne connaît pas les programmes de repérer facilement les _packages_ utilisés.
:::
