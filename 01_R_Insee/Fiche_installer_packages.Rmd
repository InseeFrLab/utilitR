...
Si le fichier est de type "source" (extension .tar.gz), Rtools peut s'avérer nécessaire, notamment si certaines fonctions sont écrites en `C` ou en `C++`. Cette solution peut être utilisée dans les cas suivants : 
