...
L'immense majorité des problèmes rencontrés à la création d'un compte SSP Cloud découle d'un `username` ne respectant pas ces règles. Si cela vous arrive malgré tout, veuillez mettre un message sur le salon Tchap `SSPCloud` (https://www.tchap.gouv.fr/#/room/#SSPCloudXDpAw6v:agent.finances.tchap.gouv.fr).
