...
::: {.remarque}
Certains exemples de cette fiche utilisent les données disponibles dans le _package_ `doremifasolData` ; vous ne pourrez reproduire les exemples que si ce package est installé sur la machine sur laquelle vous travaillez. Si vous ne savez pas si ce _package_ est déjà installé, consulter la fiche [Comment utiliser la documentation `utilitR`](#presentation-utilitr).
:::
