...
- [Cliquer sur l'onglet **"Catalogue de services"**](https://datalab.sspcloud.fr/my-lab/catalogue) qui est accessible à gauche grâce au symbole <img src = "./pics/SSPCloud/01_bouton_services.png" width = 30>.
...
Pour accéder à l'ensemble de ses services, il est nécessaire de cliquer sur le bouton <img src = "./pics/SSPCloud/03_bouton_mes_services.png" width = 30>\ .
...
Pour accéder à l'un d'eux il faut cliquer sur le bouton  <img src = "./pics/SSPCloud/Se_connecter_service.png" width = 30>\ .
...
<img src = "./pics/SSPCloud/key.png" width = 30>\ présente dans la page
*Mes services* <img src = "./pics/SSPCloud/03_bouton_mes_services.png" width = 30>\ . Cette action permet de copier le mot de passe dans le presse-papier ce qui
facilite son utilisation.

Pour accéder à un service, le bouton <img src = "./pics/SSPCloud/Se_connecter_service.png" width = 30>\ permet d'ouvrir une page d'authentification. 
...
En haut, se trouve une rangée de trois boutons utiles : <img src = "./pics/SSPCloud/04_exemple_service_kill.png" width = 15%>\ :
...
<img src = "./pics/SSPCloud/moncompte.png" width = 30>\ .
