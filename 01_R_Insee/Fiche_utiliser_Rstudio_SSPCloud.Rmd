...
Vous pouvez utiliser `R` et RStudio sur le SSP Cloud pour mener des expérimentations qui seraient difficiles à réaliser dans AUS. En revanche, le SSP Cloud ne doit pas être utilisé pour réaliser des tâches de production statistiques, ni pour traiter des données confidentielles.
:::
...
include_image("./pics/SSPCloud/99_SSPCloud_0.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_2.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_1.png", ratio_compression = 1)
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_3.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_4bis.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_5bis.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_6.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_3bis.png")
```
...
Expliquer comment cloner un projet.
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/minio/onyxia_files.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/minio/onyxia_files2.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/minio/onyxia_files3.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_Mon_compte.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_credentials.png")
```
...
```{r, echo = FALSE, fig.cap= "Dudu"}
include_image("./pics/SSPCloud/99_SSPCloud_credentials2.png")
```
