...
```{r, echo = FALSE}
R.utils::copyDirectory("../pics/SSPCloud/inline_pics", "../pics_resized/SSPCloud/inline_pics",
                       overwrite = TRUE)
```
...
- [Cliquer sur l'onglet **"Catalogue de services"**](https://datalab.sspcloud.fr/my-lab/catalogue) qui est accessible à gauche grâce au symbole <img src = "../pics_resized/SSPCloud/inline_pics/01_bouton_services.png" width = 30>.
...
Pour accéder à l'ensemble de ses services, il est nécessaire de cliquer sur le bouton <img src = "../pics_resized/SSPCloud/inline_pics/03_bouton_mes_services.png" width = 30>\ .
...
Pour accéder à l'un d'eux il faut cliquer sur le bouton  <img src = "../pics_resized/SSPCloud/inline_pics/Se_connecter_service.png" width = 30>\ .
...
<img src = "../pics_resized/SSPCloud/inline_pics/key.png" width = 30>\ présente dans la page
*Mes services* <img src = "../pics_resized/SSPCloud/inline_pics/03_bouton_mes_services.png" width = 30>\ . Cette action permet de copier le mot de passe dans le presse-papier ce qui
facilite son utilisation.

Pour accéder à un service, le bouton <img src = "../pics_resized/SSPCloud/inline_pics/Se_connecter_service.png" width = 30>\ permet d'ouvrir une page d'authentification. 
...
En haut, se trouve une rangée de trois boutons utiles : <img src = "../pics_resized/SSPCloud/inline_pics/04_exemple_service_kill.png" width = 15%>\ :
...
Il est possible d'utiliser l'interface du `SSP Cloud` pour explorer les fichiers présents dans S3 ainsi qu'ajouter ou télécharger manuellement des fichiers. Le raccourci pour accéder aux fichiers disponibles se trouve dans la barre latérale : <img src = "../pics_resized/SSPCloud/inline_pics/onyxia_files.png" width = 30>\ . En cliquant sur cette icône, on obtient la liste des *buckets* auxquels on a accès, par exemple ici le *bucket* `XXXX` :
...
<img src = "../pics_resized/SSPCloud/inline_pics/moncompte.png" width = 30>\ .
