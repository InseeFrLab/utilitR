...
Chaque fiche porte sur une tâche précise, décrite dans le titre et éventuellement dans les premières lignes. Elle présente les 


Ces fiches n'ont pas la prétention d'être exhaustives; des références figurant à la fin de chaque fiche orientent le lecteur vers des ressources plus détaillées. Les fiches comportent trois types de paragraphes mis en évidence par une icône et une couleur.
...
C'est pourquoi tous les exemples d'`utilitR` sont **reproductibles**. Cela signifie qu'en chargeant les _packages_ nécessaires, le lecteur pourra travailler sur les mêmes données et reproduire le même résultat dans son environnement de travail.
