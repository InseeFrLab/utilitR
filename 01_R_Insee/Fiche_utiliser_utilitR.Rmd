...
- La seconde partie est constituée de fiches thématiques expliquant comment réaliser des tâches standards avec `R` (importation et manipulation de données, exploitation d'enquêtes, réalisation de graphiques, rédaction de documents...). Chaque fiche énonce des recommandations et conseils pour réaliser certaines tâches. Ces fiches n'ont pas la prétention d'être exhaustives; des références figurant à la fin de chaque fiche orientent le lecteur vers des ressources plus détaillées.
